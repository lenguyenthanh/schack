...
class FenParserTests extends FunSuite:
  ...
  test("random position") {
    ...
    val board = Board(pawns = 0xc708300210ed00L, knights = 0x200200000200002L, bishops = 0x410000000001200L, rooks = 0x8100000000000021L, queens = 0x800000000000008L, kings = 0x1000000000000040L, white = 0x230ff6bL, black = 0x9fd7283000000000L, occupied = 0x9fd728300230ff6bL)
